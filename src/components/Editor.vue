<template>
  <div class="container">
    ...
    <div class="row " >
        <span class="col-sm-1 col-xs-push-5">
            <button type="button" class="btn btn-block btn-primary btn-sm ">保存</button>
        </span>
      <span class="col-sm-1 col-xs-push-5">
            <button type="button" class="btn btn-block btn-primary btn-sm ">取消</button>
        </span>
    </div>
